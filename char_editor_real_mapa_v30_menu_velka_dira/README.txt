...
- index.html už nejde přes starý loading cyklus, ale rovnou spustí menu.html?v=86.
- loading.html je jen bezpečný fallback a také rovnou spustí menu.html?v=86.
- 404.html také přesměruje na menu.html?v=86.
...
- Loading necyklí zpět na sebe; po doběhnutí jde na menu.html?v=88.
- clear_cache.html po vyčištění cache jde na loading.html?v=88.
